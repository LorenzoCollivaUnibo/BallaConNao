# BallaConNao
AI search project for creating a choreography with NAO Robot

# Authors:
* Lorenzo Colliva	lorenzo.colliva@studio.unibo.it
* Giada De Micco	giada.demicco@studio.unibo.it
...
```bash
git clone https://github.com/LorenzoCollivaUnibo/BallaConNao
```
...
**Please, remember to do the following steps before launching the script:**
  ...
  5. **Select the 'NAO H25 (V50)' as the 'Robot model'**
